...
public class EGTBBoard extends DraughtsBoard {

    /**
     * Creates a new board instance.
     */
    public EGTBBoard(long[] state) {
        turn = SOUTH;
        position = new long[POSITION_SIZE];
        System.arraycopy(state, 0, position, 0, POSITION_SIZE);
    }
}
