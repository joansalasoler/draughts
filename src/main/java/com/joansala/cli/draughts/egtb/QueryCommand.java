package com.joansala.cli.draughts.egtb;
...
import com.joansala.game.draughts.DraughtsLeaves;
...
public class QueryCommand implements Callable<Integer> {
    ...
    @Override public Integer call() throws Exception {
        ...
        try (DraughtsLeaves leaves = new DraughtsLeaves(leavesPath)) {
     ...
     */
    public void printBookEntry(int move, Board board, DraughtsLeaves leaves) {
        if (leaves.find(game)) {
            System.out.format(
                "move = %s, score = %d, flag = %s, hash = %d%n",
